...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 my-5">
    ...
    <p class="text-indent body-cert mb-3">
    This certification is being issued upon request of the above subject person as a requirement for <b>DSWD-Pantawid pamilyang Pilipino Program (4P’s) purposes.</b>
    </p>
    <p class="text-indent body-cert mb-3">
