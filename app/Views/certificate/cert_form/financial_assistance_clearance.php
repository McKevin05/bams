<!-- financial_assistance_clearance -->
<div class="row">
    ...
    <div class="clearfix"></div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
    <i>This certification is being issued upon request of the above subject person as a requirement for Financial assistance FROM DSWD for</i>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
        <div class="form-floating mb-3">
