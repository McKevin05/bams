...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name="belongs_to" id="floatingInput">
            <label for="floatingInput">Belongs to</label>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
    <i>This certification is being issued upon request of the above subject person as a requirement for Burial assistance to</i>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
        <div class="form-floating mb-3">
