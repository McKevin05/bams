								...
								<tbody>
									<?php $cnt =1; foreach ($list as $key => $row): ?>
										<tr>
											...
											<th><a href="<?php echo base_url("project/view/{$row->project_id}") ?>" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="View project"><i class="fas fa-eye"></i> View</a></th>
										</tr>
									<?php endforeach ?>
								</tbody>
							</table>
